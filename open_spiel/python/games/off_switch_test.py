...
# Lint as python3
"""Tests for Python Off-Switch Game."""
...
class OffSwitchTest(absltest.TestCase):
  ...
  def test_playthoughs_consistent(self):
    ...
    cc_playthrough = os.path.join(path, "off_switch.txt")
    py_playthrough = os.path.join(path, "python_off_switch.txt")
    ...
    self.assertEqual(
        diffs, {
            ...
            '- GameType.long_name = "Off-Switch Game"\n',
            '+ GameType.long_name = "Python Off-Switch Game"\n',
            '- GameType.short_name = "off_switch"\n',
  ...
  def test_consistent(self):
    ...
    py_game = pyspiel.load_game("python_off_switch")
    cc_game = pyspiel.load_game("off_switch")
