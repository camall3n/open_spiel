...
from open_spiel.python.games import reverse_tic_tac_toe
...
class ReverseTicTacToeTest(absltest.TestCase):

  def test_can_create_game_and_state(self):
    """Checks we can create the game and a state."""
    game = reverse_tic_tac_toe.ReverseTicTacToeGame()
  ...
  def test_game_from_cc(self):
    ...
    game = pyspiel.load_game("python_reverse_tic_tac_toe")
  ...
  def test_playthoughs_consistent(self):
    ...
    cc_playthrough = os.path.join(path, "reverse_tic_tac_toe.txt")
    py_playthrough = os.path.join(path, "python_reverse_tic_tac_toe.txt")
    ...
    self.assertEqual(
        diffs, {
            "- game: reverse_tic_tac_toe\n",
            "+ game: python_reverse_tic_tac_toe\n",
            '- GameType.long_name = "Reverse Tic Tac Toe"\n',
            '+ GameType.long_name = "Python Reverse Tic-Tac-Toe"\n',
            '- GameType.short_name = "reverse_tic_tac_toe"\n',
            '+ GameType.short_name = "python_reverse_tic_tac_toe"\n',
            '- ToString() = "reverse_tic_tac_toe()"\n',
            '+ ToString() = "python_reverse_tic_tac_toe()"\n',
            "- CurrentPlayer() = -4\n",
  ...
  def test_consistent(self):
    ...
    py_game = pyspiel.load_game("python_reverse_tic_tac_toe")
    cc_game = pyspiel.load_game("reverse_tic_tac_toe")
