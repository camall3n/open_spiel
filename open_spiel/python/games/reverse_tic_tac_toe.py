...
# Lint as python3
"""Reverse tic tac toe (noughts and crosses), implemented in Python.
...
_GAME_TYPE = pyspiel.GameType(
    short_name="python_reverse_tic_tac_toe",
    long_name="Python Reverse Tic-Tac-Toe",
...
class ReverseTicTacToeGame(pyspiel.Game):
  """A Python version of the Reverse Tic-Tac-Toe game."""
  ...
  def new_initial_state(self):
    ...
    return ReverseTicTacToeState(self)
...
class ReverseTicTacToeState(pyspiel.State):
...
pyspiel.register_game(_GAME_TYPE, ReverseTicTacToeGame)
