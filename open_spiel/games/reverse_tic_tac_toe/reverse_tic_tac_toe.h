...
#ifndef OPEN_SPIEL_GAMES_REVERSE_TIC_TAC_TOE_H_
#define OPEN_SPIEL_GAMES_REVERSE_TIC_TAC_TOE_H_
...
class ReverseTicTacToeState : public State {
 public:
  ReverseTicTacToeState(std::shared_ptr<const Game> game);

  ReverseTicTacToeState(const ReverseTicTacToeState&) = default;
  ReverseTicTacToeState& operator=(const ReverseTicTacToeState&) = default;
...
// Game object.
class ReverseTicTacToeGame : public Game {
 public:
  explicit ReverseTicTacToeGame(const GameParameters& params);
  int NumDistinctActions() const override { return kNumCells; }
  std::unique_ptr<State> NewInitialState() const override {
    return std::unique_ptr<State>(new ReverseTicTacToeState(shared_from_this()));
  }
...
#endif  // OPEN_SPIEL_GAMES_REVERSE_TIC_TAC_TOE_H_
